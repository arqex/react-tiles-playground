  ...
  render: function(){
    return (
      <div className="homeScreen">
        <h2>Welcome to multiscreen React</h2>
        ...
        { this.renderTooMany() }
        <p><span className="rt">react tiles</span> divides your app's layout in columns or rows loading one or more routes in them, the way you can use all the app's screen you need at the same time, in one browser window. Try to click the button above again!</p>
