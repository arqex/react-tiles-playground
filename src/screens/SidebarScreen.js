  ...
  render: function(){
    return (
      <div>
        ...
        <p>In <span className="rt">react-tiles</span> every tile shows a standard route of your app, so you can display several screens of you current app at the same time, increasing your users' productivity.</p>
